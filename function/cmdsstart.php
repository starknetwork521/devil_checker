...
$videoURLStart = "https://t.me/setupvideos_14/49";


if (preg_match('/^(\/start|\.start|!start)/', $text)) {
    if (in_array($userId, $freeusers)) {
        $caption = "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 <code>@$username</code> Tᴏ Dᴇᴠɪʟ Pᴠᴛ Cʜᴇᴄᴋᴇʀ 💀
...
if (preg_match('/^(\/cmds|\.cmds|!cmds)/', $text)) {
    ...
    $videoUrl = "https://t.me/setupvideos_14/49"; 
        ...
        'inline_keyboard' => [
            [
                             ['text' => '𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎', 'callback_data' => 'gates'],
                                 ...
                                 [
                                 ['text' => '@stark_network1', 'callback_data' => 'channel'],
                             ],
        ]
    ]);

    $caption = "Welcome To Dᴇᴠɪʟ Pᴠᴛ Cʜᴇᴄᴋᴇʀ 💀. Buy The Plan First.  /price 
...

{
 ...
 $caption=" Pricing Dᴇᴠɪʟ Pᴠᴛ Cʜᴇᴄᴋᴇʀ 💀 Checker📍
━━━━━━━━━━━━━━━━━━
⑄ 𝙎𝙐𝘽𝙎𝘾𝙍𝙄𝙋𝙏𝙄𝙊𝙉 𝙈𝙀𝙉𝙐 ⑄
━━━━━━━━━━━━━━━━━━
× 1 𝘞𝘌𝘌𝘒  - 3$
